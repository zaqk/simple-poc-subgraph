...
export class SolarPair__burnResult {
  value0: BigInt;
  value1: BigInt;
...
export class SolarPair__getReservesResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
...
export class SolarPair extends ethereum.SmartContract {
  static bind(address: Address): SolarPair {
    return new SolarPair("SolarPair", address);
  }
  ...
  burn(to: Address): SolarPair__burnResult {
    let result = super.call("burn", "burn(address):(uint256,uint256)", [
      ethereum.Value.fromAddress(to)
    ]);

    return new SolarPair__burnResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }

  try_burn(to: Address): ethereum.CallResult<SolarPair__burnResult> {
    ...
    return ethereum.CallResult.fromValue(
      new SolarPair__burnResult(value[0].toBigInt(), value[1].toBigInt())
    );
  }
  ...
  getReserves(): SolarPair__getReservesResult {
    let result = super.call(
      "getReserves",
    ...
    return new SolarPair__getReservesResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt()
    );
  ...
  try_getReserves(): ethereum.CallResult<SolarPair__getReservesResult> {
    let result = super.tryCall(
      "getReserves",
      "getReserves():(uint112,uint112,uint32)",
      []
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new SolarPair__getReservesResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt()
      )
