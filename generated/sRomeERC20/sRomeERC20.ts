...
export class sRomeERC20__rebasesResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class sRomeERC20 extends ethereum.SmartContract {
  static bind(address: Address): sRomeERC20 {
    return new sRomeERC20("sRomeERC20", address);
  }
  ...
  rebases(param0: BigInt): sRomeERC20__rebasesResult {
    let result = super.call(
      "rebases",
    ...
    return new sRomeERC20__rebasesResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt(),
  ...
  try_rebases(param0: BigInt): ethereum.CallResult<sRomeERC20__rebasesResult> {
    let result = super.tryCall(
      "rebases",
      "rebases(uint256):(uint256,uint256,uint256,uint256,uint256,uint256,uint256)",
      [ethereum.Value.fromUnsignedBigInt(param0)]
